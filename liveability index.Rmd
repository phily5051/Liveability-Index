...
max(proximity_wide$p_enter) # 2253
...
```{r}
# read in data
df <- read.csv('C:/Users/phily/Liveability-Index/data/domain data/final_domain_indicator_nb_450.csv')
...
# file_path = 'C:/Users/phily/Liveability-Index/data/uncertainty test/ua_rank_exp_450.csv'
...
# file_path = 'C:/Users/phily/Liveability-Index/data/uncertainty test/ua_minmax_450.csv'
...
# file_path = 'C:/Users/phily/Liveability-Index/data/uncertainty test/ua_ss_450.csv'
...
# file_path = 'C:/Users/phily/Liveability-Index/data/uncertainty test/ua_robust_450.csv'
...
file_path = 'C:/Users/phily/Liveability-Index/data/uncertainty test/ua_data_final_450.csv'
...
write_csv(baseline, 'C:/Users/phily/Liveability-Index/data/uncertainty test/li_reference_rank_450.csv')
```
...
# save data
write_csv(ua_final, 'C:/Users/phily/Liveability-Index/data/uncertainty test/ua_all_tests_rank_change_450.csv')
```
...
# save data
write_csv(dev_all, 'C:/Users/phily/Liveability-Index/data/uncertainty test/rank_dev_all_450.csv')
```
...
myplot2
ggsave('C:/Users/phily/Liveability-Index/output/uncertainty test/sd_mean_rank_450.png', plot = myplot2, width = 10, height = 8, dpi = 300)
```
...
ggsave('C:/Users/phily/Liveability-Index/output/uncertainty test/ua_rank_simulation_450.png', plot = myplot1, width = 12, height = 12, dpi = 300)
```
...
ggsave('C:/Users/phily/Liveability-Index/output/uncertainty test/ua_rank_simulation_norm_450.png', plot = myplot2, width = 12, height = 12, dpi = 300)
```
...
ggsave('C:/Users/phily/Liveability-Index/output/uncertainty test/ua_rank_simulation_div_450.png', plot = myplot3, width = 12, height = 12, dpi = 300)
```
...
# step 8: save file
file_path = 'C:/Users/phily/Liveability-Index/data/uncertainty test/average_shift_lad_450.csv'
...
# Save the plot
ggsave(filename = "C:/Users/phily/Liveability-Index/output/sensitivity analysis/sensitivity_analysis_plot.png", plot = plot, width = 10, height = 6)
...
# Save the plot
ggsave(filename = "C:/Users/phily/Liveability-Index/output/sensitivity analysis/sensitivity_analysis_diversity_plot.png", plot = plot, width = 10, height = 6)
```
...
# Save the plot
ggsave(filename = "C:/Users/phily/Liveability-Index/output/sensitivity analysis/sensitivity_analysis_proximity_plot.png", plot = plot, width = 10, height = 6)
```
