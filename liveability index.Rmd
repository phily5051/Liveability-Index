...
tm_shape(lci_1) +
  ...
  tm_layout(frame = F) +
  tm_credits("Diversity Domain", position = c(0.24,0.91), size=1.5)
...
tm_shape(lci_1) +
  ...
  tm_legend(show = F) +
  tm_layout(frame = F) +
  tm_credits("Proximity Domain", position = c(0.24,0.91), size=1.5)
...
tm_shape(lci_1) +
  ...
  tm_legend(show = F) +
  tm_layout(frame = F) +
  tm_credits('Population Density Domain', position =c(0.11,0.91), size=1.5)  
